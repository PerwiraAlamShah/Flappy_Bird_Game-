...
public class PipeSpawner : MonoBehaviour
{
    ...
    [SerializeField] public float holeSize = 2f;
    ...
    // Variable penampung coroutine yang sedang berjala
    ...
    void SpawnPipe()
    {
        ...
        float hole = Random.Range(-2f + minSpace, 3);
        newPipeUp.transform.position += Vector3.up * (hole);
        float hole2 = Random.Range(minSpace, maxSpace);
        newPipeDown.transform.position += Vector3.down * (hole2);
